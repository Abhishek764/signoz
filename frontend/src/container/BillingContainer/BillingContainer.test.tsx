...
describe('BillingContainer', () => {
	...
	describe('Trial scenarios', () => {
		...
		it('OnTrail', async () => {
			...
			await expect(screen.findByText(/1 days_remaining/i)).resolves.toBeInTheDocument();
			...
			await expect(screen.findByText(/checkout_plans/i)).resolves.toBeInTheDocument();
