...
describe('RolesSettings', () => {
	...
	it('filters roles by search query on name', async () => {
		...
		await expect(screen.findByText('billing-manager')).resolves.toBeInTheDocument();
	...
	it('shows empty state when search matches nothing', async () => {
		...
		await expect(screen.findByText('No roles match your search.')).resolves.toBeInTheDocument();
	});
	...
	it('shows empty state when API returns no roles', async () => {
		...
		await expect(screen.findByText('No roles found.')).resolves.toBeInTheDocument();
	});
	...
	it('handles invalid dates gracefully by showing fallback', async () => {
		...
		await expect(screen.findByText('invalid-date-role')).resolves.toBeInTheDocument();
