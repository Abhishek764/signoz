...
import type {
	...
	Dashboardtypesv2DashboardDataDTO,
...
/**
 * TEMP: dummy endpoint to exercise v2 spec shape while we iterate on plugin schema.
 * @summary Create dashboard v2
 */
export const createDashboardV2 = (
	dashboardtypesv2DashboardDataDTO: BodyType<Dashboardtypesv2DashboardDataDTO>,
	signal?: AbortSignal,
) => {
...
>(options?: {
	mutation?: UseMutationOptions<
		...
		TError,
		{ data: BodyType<Dashboardtypesv2DashboardDataDTO> },
		TContext
	>;
}): UseMutationOptions<
	Awaited<ReturnType<typeof createDashboardV2>>,
...
export type CreateDashboardV2MutationBody =
	BodyType<Dashboardtypesv2DashboardDataDTO>;
