...
describe('PublicDashboardSetting', () => {
	describe('Unpublished Dashboard', () => {
		it('Unpublished dashboard should be handled correctly', async () => {
			...
			await expect(screen.findByRole('checkbox', { name: /enable time range/i })).resolves.toBeInTheDocument();

			await expect(screen.findByText(/default time range/i)).resolves.toBeInTheDocument();
			...
			await expect(screen.findByRole('button', { name: /publish dashboard/i })).resolves.toBeInTheDocument();
		});
	});
	...
	describe('Published Dashboard', () => {
		it('Published dashboard should be handled correctly', async () => {
			...
			await expect(screen.findByRole('checkbox', { name: /enable time range/i })).resolves.toBeChecked();
			...
			await expect(screen.findByRole('button', { name: /update published dashboard/i })).resolves.toBeInTheDocument();

			await expect(screen.findByRole('button', { name: /unpublish dashboard/i })).resolves.toBeInTheDocument();
		});
	});
