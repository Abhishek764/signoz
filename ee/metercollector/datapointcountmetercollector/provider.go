// Package datapointcountmetercollector emits the
// signoz.meter.metric.datapoint.count meter: the count of metric datapoints
...
// Collect aggregates datapoint-count samples for the request window, broken
...
// builder: billing shape changes for datapoint.count must never bleed into
// datapoint.size.
