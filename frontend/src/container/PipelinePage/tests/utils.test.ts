...
describe('Utils testing of Pipeline Page', () => {
	...
	it('it should be return index data and perform deletion', () => {
	...
	it('it should be return modified column data', () => {
